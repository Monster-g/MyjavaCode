...
<body>
<div id="container">
    <form action="add.do" method="post" onsubmit="return fnSubmit()">
        <div id="div1">
            <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="email" id="email" onblur="fnEmail()"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="password" name="pwd" id="pwd" onblur="fnPwd()"></td>
            </tr>
            <tr>
                <td><span class="c1">*</span>密码确认</td>
                <td><input type="password" name="confirmPwd" id="confirmPwd" onblur="fnConfirmPwd()"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="truename" id="truename" onblur="fnTruename()"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="qq" id="qq" onblur="fnQq()"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input type="text" name="wx" id="wx"></td>
            </tr>
            <tr>
                <td><span class="c1">*</span>手机号码</td>
                <td><input type="text" class="c2" name="phone" id="phone" onblur="fnPhone()"><button class="c3" id="codeBtn" type="button" onclick="fnCode()">发送验证码</button></td>
            </tr>
            ...
            <tr>
                <td></td>
                <td><button class="c4">注册</button></td>
            </tr>
        </table>
    </form>
</div>
